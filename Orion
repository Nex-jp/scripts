...
local OrionLib = {
	...
	Themes = {
		...
		Test = {
			Main = Color3.fromRGB(25, 25, 25), -- Preto para o fundo
			Second = Color3.fromRGB(40, 40, 40), -- Cinza bem escuro para contraste
			Stroke = Color3.fromRGB(200, 200, 200), -- Azul bebê claro para detalhes
			Divider = Color3.fromRGB(120, 120, 120), -- Azul bebê mais escuro para divisores
			Text = Color3.fromRGB(240, 240, 240), -- Azul bebê claro para textos
			TextDark = Color3.fromRGB(180, 180, 180) -- Azul bebê amarelado para texto secundário
		}
	},
	SelectedTheme = "Test",
	Folder = nil,
...
RunService.RenderStepped:Connect(function()
    for _, obj in pairs(OrionLib.ThemeObjects.Stroke or {}) do
        obj.Color = getRainbowColor(tick())
    end
end)
