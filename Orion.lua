...
local lastDivider = OrionLib.ThemeObjects["Divider"][#OrionLib.ThemeObjects["Divider"]]
local gradient = Instance.new("UIGradient")
gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 0)),   -- 赤
    ColorSequenceKeypoint.new(0.20, Color3.fromRGB(255, 255, 0)), -- 黄
    ColorSequenceKeypoint.new(0.40, Color3.fromRGB(0, 255, 0)),   -- 緑
    ColorSequenceKeypoint.new(0.60, Color3.fromRGB(0, 255, 255)), -- 水色
    ColorSequenceKeypoint.new(0.80, Color3.fromRGB(0, 0, 255)),   -- 青
    ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 255)), -- 紫
}
gradient.Parent = lastDivider
